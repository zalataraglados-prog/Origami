...
まだ何も用意していないなら、次の順番が一番進めやすいです。

1. [まず Turso データベースを作る](/ja/turso)
2. [次に Cloudflare R2 を設定する](/ja/r2-storage)
3. [次に GitHub Auth を設定する](/ja/github-auth)
4. [必要なら最後に Gmail / Outlook OAuth を設定する](/ja/gmail-oauth)
...
- まず DB を用意したいなら [Turso データベース詳細設定](/ja/turso)
